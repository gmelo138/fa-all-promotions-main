...
interface FinanceStyleProps {
  lang?: string;
}

export const PromoInfoContainer = styled.div<FinanceStyleProps>`
...
export const AprRate = styled.div<FinanceStyleProps>`
  @media ${device.tablet} {
    display: flex;
...
export const DownpaymentRate = styled.div<FinanceStyleProps>`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: center;
